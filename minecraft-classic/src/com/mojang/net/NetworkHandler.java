...
public final class NetworkHandler {
   ...
   public NetworkHandler(String var1, int var2,Minecraft minecraft) {
	   try
	   {
		   ...
		   minecraft.online = false;
			...
			minecraft.setCurrentScreen(new ErrorScreen("Failed to connect", "You failed to connect to the server. It\'s probably down!",minecraft));
