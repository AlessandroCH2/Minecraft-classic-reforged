...
public class PacketType
{
	...
	public static final PacketType PLAYER_TELEPORT;
	public static final PacketType GET_SCOREBOARD;
	public static final PacketType SET_SCORE;
	public static final PacketType SET_HOTBARTEXT;
	public static final PacketType JOINNEWSERVER;
	public int length;
	...
	static
	{
		...
		PLAYER_TELEPORT = new PacketType(new Class[] {Byte.TYPE, Short.TYPE, Short.TYPE, Short.TYPE});
		GET_SCOREBOARD = new PacketType(new Class[] {String.class, Integer.TYPE});
		SET_SCORE = new PacketType(new Class[] {String.class, Integer.TYPE});
		SET_HOTBARTEXT = new PacketType(new Class[] {String.class});
		JOINNEWSERVER = new PacketType(new Class[] {String.class});
		nextOpcode = 0;
	}
}
