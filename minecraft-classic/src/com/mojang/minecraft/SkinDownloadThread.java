...
public class SkinDownloadThread extends Thread
{
	...
	public void run()
	{
		if(minecraft.session != null)
		{
			...
			try {
				connection = (HttpURLConnection)new URL("http://classicreforged.ddns.net/skins/" + minecraft.session.username + ".png").openConnection();
				...
				{
					System.out.print("Skin Success Getted");
