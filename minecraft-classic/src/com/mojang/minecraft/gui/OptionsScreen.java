...
public final class OptionsScreen extends GuiScreen {
   ...
   public final void onOpen() {
      ...
      this.buttons.add(new Button(100, this.width / 2 - 100, this.height / 6 + 120 + 12, Language.getLanguage().getText("controls_setting")));
      this.buttons.add(new Button(200, this.width / 2 - 100, this.height / 6 + 168, Language.getLanguage().getText("done")));
   }
