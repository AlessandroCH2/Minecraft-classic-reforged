...
public final class PauseScreen extends GuiScreen {
   ...
   public final void onOpen() {
      this.buttons.clear();
      this.buttons.add(new Button(0, this.width / 2 - 100, this.height / 4, Language.getLanguage().getText("options_setting")));
      ...
      this.buttons.add(new Button(4, this.width / 2 - 100, this.height / 4 + 120, Language.getLanguage().getText("back_to_game")));
